...
SECRET_KEY = 'django-insecure-bwg)x*&8q(y2cnqgc_c10rynxip^zztu)n%mvop(a21+57c!hg'
...
REST_FRAMEWORK = {
    ...
    'foodgram_project.pagination.CustomPagination',
    'DEFAULT_FILTER_BACKENDS': ['django_filters.rest_framework.DjangoFilterBackend']
}

DJOSER = {
    'SERIALIZERS': {
        'user_create': 'users.serializers.UserManageSerializer',
        'user': 'users.serializers.UserManageSerializer',
        'current_user': 'users.serializers.UserManageSerializer'
    },
    'LOGIN_FIELD': 'email',
    'HIDE_USERS': False,
    'PERMISSIONS': {
